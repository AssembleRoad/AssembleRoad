      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            {t(
              'contact.subtitle',
              "Vous avez des questions ou souhaitez mettre en place un pilote gratuit ? Nous sommes là pour vous aider."
            )}
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-md overflow-hidden">
          <div className="md:flex">
            <div className="md:w-1/2 bg-gradient-to-br from-blue-600 to-green-600 p-6 md:p-10 text-white">
              <h3 className="text-2xl font-bold mb-6">{t('contact.info.Title', 'Informations de contact')}</h3>
              
              <div className="space-y-4">
                <div className="flex items-start">
                  <Mail className="mr-4 flex-shrink-0" />
                  <div>
                    <p className="font-medium">{t('contact.info.email', 'Email')}</p>
                    <a 
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>{t('contact.info.address_2', 'Mons, Belgique')}</p>
                  </div>
                </div>
            ...
            <div className="md:w-1/2 p-6 md:p-10">
              ...
              >
                {t('contact.bouton', 'Envoyer un email')}
              </a>
