      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-8">
          ...
          <section className="prose prose-lg">
            ...
            <p className="mb-4">
              Si vous contactez Assemble Road via le formulaire ou par e-mail, 
              votre adresse ne sera utilisée que pour répondre à votre demande 
              et ne sera jamais cédée à des tiers.
            </p>
